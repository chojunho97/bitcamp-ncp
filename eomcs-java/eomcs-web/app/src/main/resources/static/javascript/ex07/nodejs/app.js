...
app.get('/exam04-3', (req, res) => {
  ...
  let arr = [
    {no:1,title:'제목1111111111',writer:'홍길동',viewCnt:19},
    {no:2,title:'제목2222222222',writer:'임꺽정',viewCnt:312},
    {no:3,title:'제목333333333333',writer:'유관순',viewCnt:31},
    {no:4,title:'제목444444444444444444444444444444444',writer:'안중근',viewCnt:100},
    {no:5,title:'제목5555555555555555555555555555555',writer:'윤봉길',viewCnt:200}
  ];
...
app.get('/proxy2', (req, res) => {    
  ...
  let openApiUrl = "http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtNcst?" +
    "serviceKey=Z76I1yy%2F3rDjhu%2FXYJ2M8b33YrU5BN9tnx9b%2BppRKgvU38VH3TNTiUZQ00I1IE3%2Fa6VP0QqBdfFRcli%2FBeFIxA%3D%3D" + 
    "&pageNo=1" + 
    "&numOfRows=1000" + 
    "&dataType=JSON" + 
